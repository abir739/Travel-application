...
import 'package:zenify_trip/traveller_Screens/Notification/send_Notification.dart';
...
class _TravellerCalendarPageState extends State<TravellerCalendarPage> {
  ...
  void initState() {
    ...
    // Listen for data passed from EventView
    WidgetsBinding.instance?.addPostFrameCallback((_) {
      final shouldRefresh = ModalRoute.of(context)?.settings.arguments as bool?;
      if (shouldRefresh == true) {
        // Trigger a refresh if indicated by EventView
        refreshPlanningScreen();
      }
    });
  }

// Add a method to refresh the PlanningScreen
  void refreshPlanningScreen() {
    setState(() {
      // Add any logic here to refresh your data or re-fetch it
      fetchData();
      fetchDataAndOrganizeEvents();
    });
  }
                        ...
                        children: <Widget>[
                          ...
                          ListTile(
                            ...
                            onTap: () {
                              // Handle drawer item click
                              Get.to(() =>
                                  const MainProfile()); // Close the drawer
                            },
                          ),
                               ListTile(
                            ...
                            onTap: () {
                              ...
                              Get.to(PushNotificationScreen(
                                  widget.group as TouristGroup?)); // Close the drawer
                            },
                          ),
                          ListTile(
