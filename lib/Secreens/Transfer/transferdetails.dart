...
// class transferdetalSecreen extends StatefulWidget {
//   Activity? activity;
//   String? token;

//   transferdetalSecreen(this.activity, this.token, {Key? key})
//       : super(key: key);

//   @override
//   _transferdetalSecreenState createState() =>
//       _transferdetalSecreenState();
// }

// class _transferdetalSecreenState extends State<transferdetalSecreen> {
//   HTTPHandlerTransfer activiteshanhler = HTTPHandlerTransfer();
//   late Transport activites=[];
//   String? baseUrl = "";
//   String token = "";
//   bool isLoading = true;
